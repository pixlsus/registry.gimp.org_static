(define (batch-color-contrast2 filepath file-extension keep-original 	apply-highlight highlight-cyan-red highlight-magenta-green highlight-yellow-blue 
																		...
																		apply-hls apply-h apply-l apply-s
...
(script-fu-register "batch-color-contrast2"
					"Batch Color Balance, Contrast and HLS"
					"Applys Color balance, brightness and contrast adjustments to all files in the selected folder"
					"Kristoffer Myskja <myskja@hotmail.com>"
					"Kristoffer Myskja"
					"2010-2-8 (last updated 2014-07-06)"
					""
					SF-DIRNAME "Folder" "C:\\"
					...
					SF-ADJUSTMENT "Magenta-Green color balance" '(0 -100 100 1 5 0 SF-SLIDER)
					SF-ADJUSTMENT "Yellow-Blue color balance" '(0 -100 100 1 5 0 SF-SLIDER)
					;HLS --Thanks to Yossi C.
					SF-TOGGLE _"Make Changes To Hue Lightness and Saturation" FALSE
					SF-ADJUSTMENT  "Hue Adjust"           '(0 -180 180 1 90 0 SF-SLIDER)
...
(script-fu-menu-register "batch-color-contrast2"
						 "<Toolbox>/Xtns/Misc/")
