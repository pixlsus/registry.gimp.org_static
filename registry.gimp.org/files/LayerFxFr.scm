...
(define (script-fu-layerfx-drop-shadow-fr img
				       drawable
				       color
				       opacity
				       contour
...
(define (script-fu-layerfx-inner-shadow-fr img
					drawable
					color
					opacity
					contour
...
(define (script-fu-layerfx-outer-glow-fr img
				      drawable
				      color
				      opacity
				      contour
...
(define (script-fu-layerfx-inner-glow-fr img
				      drawable
				      color
				      opacity
				      contour
...
(define (script-fu-layerfx-bevel-emboss-fr img
					drawable
					style
					depth
					direction
...
(define (script-fu-layerfx-satin-fr img
				 drawable
				 color
				 opacity
				 mode
...
(define (script-fu-layerfx-stroke-fr img
				  drawable
				  color
				  opacity
				  mode
...
(define (script-fu-layerfx-color-overlay-fr img
					 drawable
					 color
					 opacity
					 mode
...
(define (script-fu-layerfx-gradient-overlay-fr img
					    drawable
					    grad
					    gradtype
					    repeattype
...
(define (script-fu-layerfx-pattern-overlay-fr img
					   drawable
					   pattern
					   opacity
					   mode
...
(script-fu-register "script-fu-layerfx-drop-shadow-fr"
		    _"<Image>/Filters/Styles de calque/_Ombre Portee..."
		    "Ajouter une ombre portee a un calque."
		    ...
		    SF-ADJUSTMENT	"Opacite"			'(75 0 100 1 10 1 0)
		    SF-OPTION		"Contour"			'("Lineaire" "Cone" "Cone inverse" "Denivellement profond" "Denivellement leger" "Gaussien" "Demi cercle" "Rouleau" "Double rouleau" "Pente accidentee descendante" "Palliers arrondis" "Dents de scie 1")
		    SF-ADJUSTMENT	"Bruit"				'(0 0 100 1 10 1 0)
		    SF-OPTION		"Mode"				'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Grossi"			'(0 0 100 1 10 1 0)
		    SF-ADJUSTMENT	"Taille"			'(5 0 250 1 10 1 1)
		    SF-ADJUSTMENT	"Angle"				'(120 -180 180 1 10 1 0)
		    SF-ADJUSTMENT	"Distance"			'(5 0 30000 1 10 1 1)
		    SF-TOGGLE		"Ombre portee masquee par le calque"	FALSE
		    SF-TOGGLE		"Fusionner avec le calque"		FALSE)

(script-fu-register "script-fu-layerfx-inner-shadow-fr"
		    _"<Image>/Filters/Styles de calque/O_mbre Interne..."
		    "Ajouter une ombre interne a un calque"
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
		    ...
		    SF-ADJUSTMENT	"Bruit"			'(0 0 100 1 10 1 0)
		    SF-OPTION		"Mode"			'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-OPTION		"Source"		'("Contour" "Centre")
		    SF-ADJUSTMENT	"Maigri"		'(0 0 100 1 10 1 0)
		    SF-ADJUSTMENT	"Taille"		'(5 0 250 1 10 1 1)
		    SF-ADJUSTMENT	"Angle"			'(120 -180 180 1 10 1 0)
		    SF-ADJUSTMENT	"Distance"		'(5 0 30000 1 10 1 1)
		    SF-TOGGLE		"Fusionner avec le calque"	FALSE)

(script-fu-register "script-fu-layerfx-outer-glow-fr"
		    _"<Image>/Filters/Styles de calque/_Lueur Externe..."
		    "Creer une lueur externe autour d'un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
		    SF-IMAGE		"Image"				0
		    SF-DRAWABLE		"Drawable"			0
		    SF-COLOR		"Couleur"			'(255 255 190)
		    SF-ADJUSTMENT	"Opacite"			'(75 0 100 1 10 1 0)
		    SF-OPTION		"Contour"			'("Lineaire" "Cone" "Cone inverse" "Denivellement profond" "Denivellement leger" "Gaussien" "Demi cercle" "Rouleau" "Double rouleau" "Pente accidentee descendante" "Palliers arrondis" "Dents de scie 1")
		    SF-ADJUSTMENT	"Bruit"				'(0 0 100 1 10 1 0)
		    SF-OPTION		"Mode de fusion"	'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Grossi"			'(0 0 100 1 10 1 0)
		    SF-ADJUSTMENT	"Taille"				'(5 0 999 1 10 1 1)
		    SF-TOGGLE		"Lueur externe masquee par le calque"	FALSE
		    SF-TOGGLE		"Fusionner avec le calque"		FALSE)

(script-fu-register "script-fu-layerfx-inner-glow-fr"
		    _"<Image>/Filters/Styles de calque/_Lueur Interne..."
		    "Creer une lueur interne autour d'un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
...
(script-fu-register "script-fu-layerfx-bevel-emboss-fr"
		    _"<Image>/Filters/Styles de calque/_Biseautage et Estampage..."
		    "Creer des effets de biseautage et d'estampage sur un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
		    SF-IMAGE		"Image"			0
		    SF-DRAWABLE		"Drawable"		0
		    SF-OPTION		"Style"			'("Biseau Externe" "Biseau Interne" "Estampage" "Estampage Oreiller (biseau interne inverse)")
		    SF-ADJUSTMENT	"Profondeur"	'(3 1 65 1 10 0 0)
		    SF-OPTION		"Direction"		'("Haut" "Bas")
		    SF-ADJUSTMENT	"Taille"		'(5 0 250 1 10 0 0)
		    SF-ADJUSTMENT	"Flou"			'(0 0 16 1 2 0 0)
		    SF-ADJUSTMENT	"Angle"			'(120 -180 180 1 10 1 0)
		    SF-ADJUSTMENT	"Elevation"		'(30 0 90 1 10 1 0)
		    SF-OPTION		"Contour brillant"		'("Lineaire" "Cone" "Cone inverse" "Denivellement profond" "Denivellement leger" "Gaussien" "Demi cercle" "Rouleau" "Double rouleau" "Pente accidentee descendante" "Palliers arrondis" "Dents de scie 1")
		    SF-COLOR		"Couleur tons clairs"	'(255 255 255)
		    SF-OPTION		"Mode tons clairs"		'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Opacite tons clairs"	'(75 0 100 1 10 1 0)
		    SF-COLOR		"Couleur tons fonces"	'(0 0 0)
		    SF-OPTION		"Mode tons fonces"		'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Opacite tons fonces"	'(75 0 100 1 10 1 0)
		    SF-OPTION		"Contour"				'("Lineaire" "Cone" "Cone inverse" "Denivellement profond" "Denivellement leger" "Gaussien" "Demi cercle" "Rouleau" "Double rouleau" "Pente accidentee descendante" "Palliers arrondis" "Dents de scie 1")
		    SF-TOGGLE		"Inverser"			FALSE
		    SF-TOGGLE		"Fusionner avec le calque"	FALSE)

(script-fu-register "script-fu-layerfx-satin-fr"
		    _"<Image>/Filters/Styles de calque/_Satin..."
		    "Creer un effet satin sur un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
		    ...
		    SF-ADJUSTMENT	"Opacite"		'(75 0 100 1 10 1 0)
		    SF-OPTION		"Mode"			'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Angle"			'(19 -180 180 1 10 1 0)
		    SF-ADJUSTMENT	"Distance"		'(11 0 30000 1 10 1 1)
		    SF-ADJUSTMENT	"Taille"		'(14 0 250 1 10 0 0)
		    SF-OPTION		"Contour"		'("Lineaire" "Cone" "Cone inverse" "Denivellement profond" "Denivellement leger" "Gaussien" "Demi cercle" "Rouleau" "Double rouleau" "Pente accidentee descendante" "Palliers arrondis" "Dents de scie 1")
		    SF-TOGGLE		"Inverser"			TRUE
		    SF-TOGGLE		"Fusionner avec le calque"	FALSE)

(script-fu-register "script-fu-layerfx-stroke-fr"
		    _"<Image>/Filters/Styles de calque/C_ontour..."
		    "Creer un contour autour d'un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
		    ...
		    SF-ADJUSTMENT	"Opacite"				'(100 0 100 1 10 1 0)
		    SF-OPTION		"Mode de fusion"		'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Taille"				'(1 1 999 1 10 0 1)
		    SF-ADJUSTMENT	"Position (0 = interieur, 100 = exterieur)"	'(50 0 100 1 10 1 0)
		    SF-TOGGLE		"Fusionner avec le calque"			FALSE)

(script-fu-register "script-fu-layerfx-color-overlay-fr"
		    _"<Image>/Filters/Styles de calque/_Incrustation Couleur..."
		    "Incruster couleur sur un claque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
...
(script-fu-register "script-fu-layerfx-gradient-overlay-fr"
		    _"<Image>/Filters/Styles de calque/_Incrustation Degrade..."
		    "Incruster un degrade sur un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
		    SF-IMAGE		"Image"			0
		    SF-DRAWABLE		"Drawable"		0
		    SF-GRADIENT		"Degrade"		"Default"
		    SF-OPTION		"Type"			'("Lineaire" "Bi-lineaire" "Radial" "Carre" "Conique (symetrique)" "Conique (asymetrique)" "Suivant la forme (angulaire)" "Suivant la forme (spherique)" "Suivant la forme (excroissances)" "Spirale (sens horaire)" "Spirale (sens anti-horaire)")
		    SF-OPTION		"Repeter"		'("Non" "Dents de scie" "Onde triangulaire")
		    SF-TOGGLE		"Inverser"		FALSE
		    SF-ADJUSTMENT	"Opacite"		'(100 0 100 1 10 1 0)
		    SF-OPTION		"Mode de fusion"		'("Normal" "Dissoudre" "Multipler" "Diviser" "Ecran" "Superposer" "Eclaircir" "Assombrir" "Lumiere Dure" "Lumiere Douce" "Extraction de Grain" "Fusion de Grain" "Difference" "Addition" "Soustraire" "Assombrir Seulement" "Eclaircir Seulement" "Teinte" "Saturation" "Couleur" "Valeur")
		    SF-ADJUSTMENT	"Centre X"		'(0 0 262144 1 10 0 1)
		    SF-ADJUSTMENT	"Centre Y"		'(0 0 262144 1 10 0 1)
		    SF-ADJUSTMENT	"Angle"			'(90 -180 180 1 10 1 0)
		    SF-ADJUSTMENT	"Echelle"		'(10 0 262144 1 10 1 1)
		    SF-TOGGLE		"Fusionner avec le calque"	FALSE)

(script-fu-register "script-fu-layerfx-pattern-overlay-fr"
		    _"<Image>/Filters/Styles de calque/_Incrustation Motif..."
		    "Incruster un motif sur un calque."
		    "Jonathan Stipe <JonStipe@prodigy.net>"
		    "Jonathan Stipe"
		    "January 2008"
		    "RGBA, GRAYA"
