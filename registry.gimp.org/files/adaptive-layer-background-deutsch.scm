...
; color gradient, but adaptive to the layer contents.
...
(define (
	 script-fu-adaptive-layer-background-deutsch
	 inImage
	 inDrawable
	 inBlur
	 inFinalBlur
  ...
  (let
	...
	(gimp-layer-set-name finalBackground
			     (string-append bgName " (" _"Hintergrund" ")"))
...
(script-fu-register
  "script-fu-adaptive-layer-background-deutsch"
  "<Image>/Filters/Generic/Adaptiver Ebenenhintergrund"
  _"Fügt der ausgewählten Ebene einen adaptiven Hintergrund hinzu"
  ...
  SF-ADJUSTMENT	_"Horizontale Streckung *" '(2000 1 5984 1 100 0 1)
  SF-ADJUSTMENT	_"Weichzeichnung *"		'(100 1 5984 1 50 0 1)
  SF-ADJUSTMENT	_"Intensität des Hintergrundes"	'(4 1 50 1 5 0 1)
  SF-COLOR	_"Grundfarbe des Hintergrundes"	'(83 83 83)
  SF-TOGGLE	_"Hintergrund mit Farbe füllen"	1
  SF-TOGGLE	_"Interaktives Weichzeichnen (ignoriert alles mit Sternchen)" 0
  )
