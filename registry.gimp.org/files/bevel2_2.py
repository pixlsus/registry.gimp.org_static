...
#width
                ...
                self.width_spinner = self.make_slider_and_spinner(10.0, 1.0, 250.0, 0.5, 5.0, 1)
...
#height
                ...
                self.height_spinner = self.make_slider_and_spinner(10.0, 1.0, 250.0, 0.5, 5.0, 1)
...
#start effect
        ...
        #gloss
                if gloss > 0:
                    ...
                    pdb.gimp_curves_spline(newlayer, 0, 16, (0,0, 63,(63 + y1), 95,(95 + y2), 127,(127 - y3), 156,(156 + y4), 191,(191 - y5), 223,(223 + y6), 255,255))
