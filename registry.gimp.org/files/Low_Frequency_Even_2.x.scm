...
;
; This is version for GIMP 2.x
; For use with GIMP 2.7 or higer you need to download script dedicated for this version.
; For newest versions or updates check: http://registry.gimp.org
;
; Changelog:
;   Version 1.1
;      - "tmp-layer error" fixed
;      - Added GIMP 2.7 support (you need to download it)
;
;   Version 1.0
;      - Initial release
;
