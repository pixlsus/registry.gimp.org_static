  ...
  (let* (
	...
	(if (= fk-batch-call-state FALSE)
	  (begin
		...
		(gimp-item-set-name temp-layer "Источник = Видимое")
		(set! exit-layer
		  (car
...
(define fil-controls
  ...
  SF-TOGGLE	"Эффект монокля"			FALSE
