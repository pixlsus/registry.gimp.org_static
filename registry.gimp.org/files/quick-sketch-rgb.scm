...
;
; The script is located in "<Image> / Script-Fu/ Artistic / Quick sketch RGB..."
;
...
(define (script-fu-quick-sketch-rgb     theImage
                    theLayer
                    blurAmount)
    ...
    (let* (
    (layerCopy 0)
    (layerrgb (car (gimp-drawable-is-rgb theLayer)))
    )
    ...
    ;Rename the layer
    (gimp-drawable-set-name theLayer "Originale")
    ...
    ;Rename the layer
    (gimp-drawable-set-name layerCopy "Livello scherma")

    ;Invert the layer
    (gimp-invert layerCopy)

    ;Desaturate the layer
    (gimp-desaturate layerCopy)
...
(script-fu-register "script-fu-quick-sketch-rgb"
            _"<Image>/Script-Fu/Artistic/Quick sketch RGB..."
