...
(define (
	 script-fu-highlight-from-selection
	 inImage
	 inLayer
	 inRadius
	 inBlur
...
(script-fu-register
  "script-fu-highlight-from-selection"
  "<Image>/Filters/Generic/Highlight from selection"
  _"Highlights the selection by adding blur and desaturation to other contents."
  ...
  SF-ADJUSTMENT	_"Highlight Radius"			'(100 0 500 1 10 0 0)
  SF-ADJUSTMENT	_"Blur strenght"			'(3 0 10 1 10 0 0)
  SF-ADJUSTMENT	_"Opacity of desaturation"		'(50 0 100 1 10 0 0)
  SF-TOGGLE	_"Desaturate the not highlighted parts"	TRUE
  )
