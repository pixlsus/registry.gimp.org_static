;
; Highpass Filter Sharpening, V2.8
;
...
;
			(cond
				...
				((= InFlatten FALSE) 
					(begin
						(gimp-item-set-name SharpenLayer "Sharpened")
...
(script-fu-register 
	...
	SF-ADJUSTMENT	"Blur Radius"	'(7.0 1.0 80.0 1.0 0 2 0)
	SF-ADJUSTMENT	"Sharpening Layer Opacity" '(55.0 1.0 100.0 1.0 0 2 0)
