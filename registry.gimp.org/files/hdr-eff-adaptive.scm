...
(define (script-fu-fake-hdr-effect-adaptive inImage inDrawable softvalue1 softvalue2 softvalue3  lev3min Opa-num thin thick lev5min lev5max)
	...
	(let* (
		...
		(gimp-image-set-active-layer inImage theNewlayer3)
		(set! subdra (plug-in-ace RUN-NONINTERACTIVE inImage theNewlayer3 1.0 0.0 10 0 25 0 0))
...
(script-fu-register
    "script-fu-fake-hdr-effect-adaptive"
    "<Image>/Script-Fu/Enhance/Fake HDR Effect adaptive..."
