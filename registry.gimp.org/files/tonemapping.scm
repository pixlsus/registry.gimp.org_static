...
; detail.
;
; The script is located in menu "<Image> / Script-Fu / Second / Name"
;
...
(define (script-fu-tone-mapping		theImage
					theLayer
					blurAmount
					opacityAmount
					flattenImage)
    ...
    ;Flatten image
    (if (= flattenImage TRUE) (gimp-image-flatten theImage))
...
(script-fu-register "script-fu-tone-mapping"
            _"<Image>/Script-Fu/Enhance/Tone Mapping..."
            ...
            SF-ADJUSTMENT	_"Blur:"     '(150 100 500 10 10 1 0)
	    SF-ADJUSTMENT	_"Opacity"      '(90 0 100 1 10 1 0)
	    SF-TOGGLE		"Flatten result?"       FALSE
)            
